...
from eegda.datasets.standard_npz import StandardDataset, make_toy_dataset, save_standard_dataset
from eegda.registries import (
    get_dataset,
    get_method,
    get_model,
...
def run(**kwargs: Any):
    from eegda.train import run_from_kwargs
